...
nonisolated private func argoLocalizedSettingsString(_ key: String) -> String {
...
nonisolated enum SidebarIconFillStyle: String, Codable, Hashable, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .solid:
            return argoLocalizedSettingsString("settings.sidebarIcon.style.solid")
        case .gradient:
            return argoLocalizedSettingsString("settings.sidebarIcon.style.gradient")
        }
    }
}
...
nonisolated enum SidebarIconPalette: String, Codable, Hashable, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .blue:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.blue")
        case .cyan:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.cyan")
        case .aqua:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.aqua")
        case .ice:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.ice")
        case .sky:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.sky")
        case .teal:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.teal")
        case .turquoise:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.turquoise")
        case .mint:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.mint")
        case .green:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.green")
        case .forest:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.forest")
        case .lime:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.lime")
        case .olive:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.olive")
        case .gold:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.gold")
        case .sand:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.sand")
        case .bronze:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.bronze")
        case .amber:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.amber")
        case .orange:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.orange")
        case .copper:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.copper")
        case .rust:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.rust")
        case .coral:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.coral")
        case .peach:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.peach")
        case .brick:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.brick")
        case .crimson:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.crimson")
        case .ruby:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.ruby")
        case .berry:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.berry")
        case .rose:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.rose")
        case .magenta:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.magenta")
        case .orchid:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.orchid")
        case .indigo:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.indigo")
        case .navy:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.navy")
        case .steel:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.steel")
        case .violet:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.violet")
        case .iris:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.iris")
        case .lavender:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.lavender")
        case .plum:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.plum")
        case .slate:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.slate")
        case .smoke:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.smoke")
        case .charcoal:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.charcoal")
        case .graphite:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.graphite")
        case .mocha:
            return argoLocalizedSettingsString("settings.sidebarIcon.palette.mocha")
        }
    }
}
...
nonisolated enum IslandWidthPreset: String, Codable, Hashable, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .compact:   return argoLocalizedSettingsString("settings.dynamicIsland.width.compact")
        case .standard:  return argoLocalizedSettingsString("settings.dynamicIsland.width.standard")
        case .wide:      return argoLocalizedSettingsString("settings.dynamicIsland.width.wide")
        case .extraWide: return argoLocalizedSettingsString("settings.dynamicIsland.width.extraWide")
        case .full:      return argoLocalizedSettingsString("settings.dynamicIsland.width.full")
        }
    }
}
...
nonisolated enum IslandHeightPreset: String, Codable, Hashable, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .compact:  return argoLocalizedSettingsString("settings.dynamicIsland.height.compact")
        case .notch:    return argoLocalizedSettingsString("settings.dynamicIsland.height.notch")
        case .tall:     return argoLocalizedSettingsString("settings.dynamicIsland.height.tall")
        }
    }
}
...
struct AppSettings: Codable, Hashable {
    ...
    init(
        ...
        let normalizedKeyboardShortcutOverrides = ArgoKeyboardShortcuts.normalizedOverrides(keyboardShortcutOverrides)
        let normalizedAgentPresets = argoNormalizedAgentPresets(agentPresets)
        let normalizedSSHPresets = argoNormalizedSSHPresets(sshPresets)
        ...
        self.quickCommandPresets = QuickCommandCatalog.normalizedCommands(
            ...
            reservedShortcuts: ArgoKeyboardShortcuts.effectiveShortcuts(using: normalizedKeyboardShortcutOverrides)
        )
...
extension AppSettings {
    ...
    init(from decoder: any Decoder) throws {
        ...
        let decodedTwilightThemeEnabled = try container.decodeIfPresent(Bool.self, forKey: .twilightThemeEnabled) ?? true
...
private func argoNormalizedAgentPresets(_ presets: [AgentPreset]) -> [AgentPreset] {
...
private func argoNormalizedSSHPresets(_ presets: [SSHPreset]) -> [SSHPreset] {
...
enum ArgoShortcutCategory: String, CaseIterable, Hashable, Identifiable {
    case general
    case workspace
    case tabs
    case panes
    ...
    var title: String {
        switch self {
        case .general:
            return argoLocalizedSettingsString("settings.shortcuts.category.general")
        case .workspace:
            return argoLocalizedSettingsString("settings.shortcuts.category.workspace")
        case .tabs:
            return argoLocalizedSettingsString("settings.shortcuts.category.tabs")
        case .panes:
            return argoLocalizedSettingsString("settings.shortcuts.category.panes")
        case .window:
            return argoLocalizedSettingsString("settings.shortcuts.category.window")
        }
    }
}

enum ArgoShortcutAction: String, CaseIterable, Hashable, Identifiable {
    case hideApp
    case hideOtherApps
    case quitApp
    case newWindow
    ...
    var category: ArgoShortcutCategory {
        switch self {
        case .hideApp,
             .hideOtherApps,
             .quitApp,
    ...
    var title: String {
        switch self {
        case .hideApp:
            return argoLocalizedSettingsString("settings.shortcuts.action.hideApp.title")
        case .hideOtherApps:
            return argoLocalizedSettingsString("settings.shortcuts.action.hideOtherApps.title")
        case .quitApp:
            return argoLocalizedSettingsString("settings.shortcuts.action.quitApp.title")
        case .newWindow:
            return argoLocalizedSettingsString("settings.shortcuts.action.newWindow.title")
        case .openSettings:
            return argoLocalizedSettingsString("settings.shortcuts.action.openSettings.title")
        case .undo:
            return argoLocalizedSettingsString("settings.shortcuts.action.undo.title")
        case .redo:
            return argoLocalizedSettingsString("settings.shortcuts.action.redo.title")
        case .cut:
            return argoLocalizedSettingsString("settings.shortcuts.action.cut.title")
        case .copy:
            return argoLocalizedSettingsString("settings.shortcuts.action.copy.title")
        case .paste:
            return argoLocalizedSettingsString("settings.shortcuts.action.paste.title")
        case .selectAll:
            return argoLocalizedSettingsString("settings.shortcuts.action.selectAll.title")
        case .find:
            return argoLocalizedSettingsString("settings.shortcuts.action.find.title")
        case .findNext:
            return argoLocalizedSettingsString("settings.shortcuts.action.findNext.title")
        case .findPrevious:
            return argoLocalizedSettingsString("settings.shortcuts.action.findPrevious.title")
        case .hideFind:
            return argoLocalizedSettingsString("settings.shortcuts.action.hideFind.title")
        case .toggleCommandPalette:
        ...
        case .refreshAllRepositories:
            return argoLocalizedSettingsString("settings.shortcuts.action.refreshAllRepositories.title")
        case .nextWorkspace:
            return argoLocalizedSettingsString("settings.shortcuts.action.nextWorkspace.title")
        case .previousWorkspace:
            return argoLocalizedSettingsString("settings.shortcuts.action.previousWorkspace.title")
        case .newTab:
            return argoLocalizedSettingsString("settings.shortcuts.action.newTab.title")
        case .closeTab:
            return argoLocalizedSettingsString("settings.shortcuts.action.closeTab.title")
        case .nextTab:
            return argoLocalizedSettingsString("settings.shortcuts.action.nextTab.title")
        case .previousTab:
            return argoLocalizedSettingsString("settings.shortcuts.action.previousTab.title")
        case .selectTabByNumber:
            return argoLocalizedSettingsString("settings.shortcuts.action.selectTabByNumber.title")
        case .focusPaneLeft:
            return argoLocalizedSettingsString("settings.shortcuts.action.focusPaneLeft.title")
        case .focusPaneRight:
            return argoLocalizedSettingsString("settings.shortcuts.action.focusPaneRight.title")
        case .focusPaneUp:
            return argoLocalizedSettingsString("settings.shortcuts.action.focusPaneUp.title")
        case .focusPaneDown:
            return argoLocalizedSettingsString("settings.shortcuts.action.focusPaneDown.title")
        case .splitRight:
            return argoLocalizedSettingsString("settings.shortcuts.action.splitRight.title")
        case .splitDown:
            return argoLocalizedSettingsString("settings.shortcuts.action.splitDown.title")
        case .duplicatePane:
            return argoLocalizedSettingsString("settings.shortcuts.action.duplicatePane.title")
        case .togglePaneZoom:
            return argoLocalizedSettingsString("settings.shortcuts.action.togglePaneZoom.title")
        case .closePane:
            return argoLocalizedSettingsString("settings.shortcuts.action.closePane.title")
        case .resetTerminal:
            return argoLocalizedSettingsString("settings.shortcuts.action.resetTerminal.title")
        case .minimizeWindow:
            return argoLocalizedSettingsString("settings.shortcuts.action.minimizeWindow.title")
        case .closeWindow:
            return argoLocalizedSettingsString("settings.shortcuts.action.closeWindow.title")
        case .enterFullScreen:
            return argoLocalizedSettingsString("settings.shortcuts.action.enterFullScreen.title")
        }
    }
    ...
    var subtitle: String {
        switch self {
        case .hideApp:
            return argoLocalizedSettingsString("settings.shortcuts.action.hideApp.subtitle")
        case .hideOtherApps:
            return argoLocalizedSettingsString("settings.shortcuts.action.hideOtherApps.subtitle")
        case .quitApp:
            return argoLocalizedSettingsString("settings.shortcuts.action.quitApp.subtitle")
        case .newWindow:
            return argoLocalizedSettingsString("settings.shortcuts.action.newWindow.subtitle")
        case .openSettings:
            return argoLocalizedSettingsString("settings.shortcuts.action.openSettings.subtitle")
        case .undo:
            return argoLocalizedSettingsString("settings.shortcuts.action.undo.subtitle")
        case .redo:
            return argoLocalizedSettingsString("settings.shortcuts.action.redo.subtitle")
        case .cut:
            return argoLocalizedSettingsString("settings.shortcuts.action.cut.subtitle")
        case .copy:
            return argoLocalizedSettingsString("settings.shortcuts.action.copy.subtitle")
        case .paste:
            return argoLocalizedSettingsString("settings.shortcuts.action.paste.subtitle")
        case .selectAll:
            return argoLocalizedSettingsString("settings.shortcuts.action.selectAll.subtitle")
        case .find:
            return argoLocalizedSettingsString("settings.shortcuts.action.find.subtitle")
        case .findNext:
            return argoLocalizedSettingsString("settings.shortcuts.action.findNext.subtitle")
        case .findPrevious:
            return argoLocalizedSettingsString("settings.shortcuts.action.findPrevious.subtitle")
        case .hideFind:
            return argoLocalizedSettingsString("settings.shortcuts.action.hideFind.subtitle")
        case .toggleCommandPalette:
        ...
        case .refreshAllRepositories:
            return argoLocalizedSettingsString("settings.shortcuts.action.refreshAllRepositories.subtitle")
        case .nextWorkspace:
            return argoLocalizedSettingsString("settings.shortcuts.action.nextWorkspace.subtitle")
        case .previousWorkspace:
            return argoLocalizedSettingsString("settings.shortcuts.action.previousWorkspace.subtitle")
        case .newTab:
            return argoLocalizedSettingsString("settings.shortcuts.action.newTab.subtitle")
        case .closeTab:
            return argoLocalizedSettingsString("settings.shortcuts.action.closeTab.subtitle")
        case .nextTab:
            return argoLocalizedSettingsString("settings.shortcuts.action.nextTab.subtitle")
        case .previousTab:
            return argoLocalizedSettingsString("settings.shortcuts.action.previousTab.subtitle")
        case .selectTabByNumber:
            return argoLocalizedSettingsString("settings.shortcuts.action.selectTabByNumber.subtitle")
        case .focusPaneLeft:
            return argoLocalizedSettingsString("settings.shortcuts.action.focusPaneLeft.subtitle")
        case .focusPaneRight:
            return argoLocalizedSettingsString("settings.shortcuts.action.focusPaneRight.subtitle")
        case .focusPaneUp:
            return argoLocalizedSettingsString("settings.shortcuts.action.focusPaneUp.subtitle")
        case .focusPaneDown:
            return argoLocalizedSettingsString("settings.shortcuts.action.focusPaneDown.subtitle")
        case .splitRight:
            return argoLocalizedSettingsString("settings.shortcuts.action.splitRight.subtitle")
        case .splitDown:
            return argoLocalizedSettingsString("settings.shortcuts.action.splitDown.subtitle")
        case .duplicatePane:
            return argoLocalizedSettingsString("settings.shortcuts.action.duplicatePane.subtitle")
        case .togglePaneZoom:
            return argoLocalizedSettingsString("settings.shortcuts.action.togglePaneZoom.subtitle")
        case .closePane:
            return argoLocalizedSettingsString("settings.shortcuts.action.closePane.subtitle")
        case .resetTerminal:
            return argoLocalizedSettingsString("settings.shortcuts.action.resetTerminal.subtitle")
        case .minimizeWindow:
            return argoLocalizedSettingsString("settings.shortcuts.action.minimizeWindow.subtitle")
        case .closeWindow:
            return argoLocalizedSettingsString("settings.shortcuts.action.closeWindow.subtitle")
        case .enterFullScreen:
            return argoLocalizedSettingsString("settings.shortcuts.action.enterFullScreen.subtitle")
        }
    }
...
enum ArgoKeyboardShortcutState: Equatable {
    case `default`
    case custom
    case disabled
}

enum ArgoKeyboardShortcuts {
    ...
    static func effectiveShortcut(for action: ArgoShortcutAction, in settings: AppSettings) -> StoredShortcut? {
    ...
    static func state(for action: ArgoShortcutAction, in settings: AppSettings) -> ArgoKeyboardShortcutState {
    ...
    static func displayString(for action: ArgoShortcutAction, in settings: AppSettings) -> String {
    ...
    static func effectiveShortcuts(using overrides: [String: KeyboardShortcutOverride]) -> Set<StoredShortcut> {
        Set(
            ArgoShortcutAction.allCases.compactMap { action in
    ...
    static func setShortcut(_ shortcut: StoredShortcut, for action: ArgoShortcutAction, in settings: inout AppSettings) {
        guard let normalizedShortcut = action.normalizedRecordedShortcut(shortcut) else { return }

        for otherAction in ArgoShortcutAction.allCases where otherAction != action {
    ...
    static func disableShortcut(for action: ArgoShortcutAction, in settings: inout AppSettings) {
        settings.keyboardShortcutOverrides[action.rawValue] = KeyboardShortcutOverride(shortcut: nil)
        settings.keyboardShortcutOverrides = normalizedOverrides(settings.keyboardShortcutOverrides)
    }

    static func resetShortcut(for action: ArgoShortcutAction, in settings: inout AppSettings) {
        settings.keyboardShortcutOverrides.removeValue(forKey: action.rawValue)
        settings.keyboardShortcutOverrides = normalizedOverrides(settings.keyboardShortcutOverrides)
    }
    ...
    static func normalizedOverrides(_ overrides: [String: KeyboardShortcutOverride]) -> [String: KeyboardShortcutOverride] {
        var candidates: [ArgoShortcutAction: Candidate] = [:]

        for action in ArgoShortcutAction.allCases {
...
struct ArgoShortcutMatch: Equatable {
    var action: ArgoShortcutAction
    var tabNumber: Int?
}

func argoShortcutMatch(for event: NSEvent, in settings: AppSettings) -> ArgoShortcutMatch? {
    guard let recordedShortcut = StoredShortcut.from(event: event) else { return nil }

    for action in ArgoShortcutAction.allCases {
        guard let effectiveShortcut = ArgoKeyboardShortcuts.effectiveShortcut(for: action, in: settings) else {
            continue
        }
        ...
        if action.usesNumberedDigitMatching {
            ...
            return ArgoShortcutMatch(action: action, tabNumber: tabNumber)
        }

        if recordedShortcut == effectiveShortcut {
            return ArgoShortcutMatch(action: action, tabNumber: nil)
        }
    }
