//
//  ArgoGhosttyShellIntegration.swift
//  Argo
//
//  Author: krystal
//
...
struct ArgoGhosttyResourcePaths: Equatable {
    ...
    static func bundleMain() -> ArgoGhosttyResourcePaths {
        ArgoGhosttyResourcePaths(resourceRootURL: Bundle.main.resourceURL)
    }
}

enum ArgoGhosttyShellIntegration {
    private static let defaultShellFeatures = ["ssh-env"]

    static func prepare(
        command: TerminalCommandDefinition,
        environment: [String: String],
        resourcePaths: ArgoGhosttyResourcePaths = .bundleMain()
