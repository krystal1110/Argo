...
func argoQuickCommandMatch(for event: NSEvent, in settings: AppSettings) -> QuickCommandPreset? {
...
func argoQuickCommandDispatch(for preset: QuickCommandPreset) -> QuickCommandDispatch {
