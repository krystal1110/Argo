...
struct CommandPaletteView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .frame(width: 640)
            .background(ArgoTheme.canvasBackground, in: RoundedRectangle(cornerRadius: 9, style: .continuous))
            .overlay(
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 5, style: .continuous)
                .fill(ArgoTheme.subtleFill.opacity(isSelected || isHovering ? 1 : 0))
        )
