...
struct DiffWindowContentView: View {
    ...
    @AppStorage("argo.diff.viewStyle") private var diffStyleRaw = DiffPresentationStyle.split.rawValue
    @AppStorage("argo.diff.zoom") private var zoomLevel: Double = 1.0
