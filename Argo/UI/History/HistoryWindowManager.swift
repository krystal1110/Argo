...
final class HistoryWindowManager: NSObject, NSWindowDelegate {
    ...
    func show(worktreePath: String?, branchName: String, emptyStateMessage: String) {
        ...
        newWindow.identifier = NSUserInterfaceItemIdentifier("argo.history")
        ...
        newWindow.setFrameAutosaveName("ArgoHistoryWindow")

        let hasSavedFrame = UserDefaults.standard.string(forKey: "NSWindow Frame ArgoHistoryWindow") != nil
        if !hasSavedFrame {
