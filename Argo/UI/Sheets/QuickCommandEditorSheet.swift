...
struct QuickCommandEditorSheet: View {
    ...
    private var topBar: some View {
        ...
        .padding(.top, 10)
        .padding(.bottom, 10)
        .background(ArgoTheme.panelBackground.opacity(0.98))
    ...
    private var sidebar: some View {
        ...
        .background(ArgoTheme.appBackground.opacity(0.16))
    }
    ...
    private var detailPane: some View {
        ...
        .frame(maxWidth: .infinity, maxHeight: .infinity)
        .background(ArgoTheme.panelBackground.opacity(0.72))
    }
    ...
    private func infoCard(_ text: String) -> some View {
        ...
        .frame(maxWidth: .infinity, alignment: .leading)
        .padding(16)
        .background(ArgoTheme.subtleFill, in: RoundedRectangle(cornerRadius: 7, style: .continuous))
        .overlay(
...
private struct QuickCommandDetailLoadingState: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            HStack(alignment: .top, spacing: 10) {
                RoundedRectangle(cornerRadius: 2, style: .continuous)
                    .fill(ArgoTheme.subtleRaisedFill)
        ...
        .background(ArgoTheme.panelRaised, in: RoundedRectangle(cornerRadius: 9, style: .continuous))
        .overlay(
...
private struct QuickCommandLoadingRow: View {
    var body: some View {
        ...
        .padding(.horizontal, 10)
        .padding(.vertical, 6)
        .background(ArgoTheme.appBackground.opacity(0.28), in: RoundedRectangle(cornerRadius: 6, style: .continuous))
    }
}
...
private struct QuickCommandListItem: View {
                ...
                VStack(alignment: .leading, spacing: 1) {
                    HStack(spacing: 6) {
                        ...
                        if command.submitsReturn {
                            QuickCommandMetaTag(title: "Return", tint: ArgoTheme.success)
                        }
    ...
    private var backgroundColor: Color {
        isSelected ? tint.opacity(0.16) : ArgoTheme.subtleFill
    }

    private var borderColor: Color {
        isSelected ? tint.opacity(0.55) : ArgoTheme.border
    }
...
private struct QuickCommandLibraryCategoryRow: View {
    ...
    var body: some View {
        ...
        .foregroundStyle(isSelected ? ArgoTheme.accent : ArgoTheme.secondaryText)
        .padding(.horizontal, 10)
        .padding(.vertical, 8)
        .background(
            RoundedRectangle(cornerRadius: 6, style: .continuous)
                .fill(isSelected ? ArgoTheme.accent.opacity(0.12) : ArgoTheme.subtleFill)
        )
        .overlay(
            RoundedRectangle(cornerRadius: 6, style: .continuous)
                .stroke(isSelected ? ArgoTheme.accent.opacity(0.35) : ArgoTheme.border, lineWidth: 1)
        )
    }
}
...
private struct QuickCommandLibraryItem: View {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    HStack {
                        ...
                        if isAlreadyImported {
                            QuickCommandMetaTag(title: "Added", tint: ArgoTheme.secondaryText)
                        } else if isSelected {
                            QuickCommandMetaTag(title: "Selected", tint: ArgoTheme.accent)
                        }
                    }
    ...
    private var backgroundColor: Color {
        ...
        return isSelected ? ArgoTheme.accent.opacity(0.12) : ArgoTheme.panelRaised
    }
    ...
    private var borderColor: Color {
        ...
        return isSelected ? ArgoTheme.accent.opacity(0.35) : ArgoTheme.border
    }
}
        ...
        HStack(spacing: 12) {
            VStack(alignment: .leading, spacing: 10) {
                HStack(spacing: 12) {
                    ...
                    .padding(.vertical, 6)
                    .background(ArgoTheme.panelBackground, in: Capsule())
                    .overlay(
                        Capsule()
                            .stroke(ArgoTheme.border, lineWidth: 1)
                    )
