...
- Git 工作区干净，没有未提交改动
- 本机可用 `curl` 和 `python3`
- GitHub CLI 可用，并已通过 `gh auth login` 登录；或运行时已设置具备 release 权限的 `GH_TOKEN` / `GITHUB_TOKEN`
...
Argo 发布产物现在发布到 GitHub：

- 项目：`https://github.com/krystal1110/Argo`
