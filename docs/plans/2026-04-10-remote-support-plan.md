...
**Goal:** Add comprehensive remote server support to Argo — SSH config parsing, connection testing, SFTP browsing, tmux auto-detection/restoration, remote git inspection, periodic refresh, and a dedicated remote workspace creation UI.
...
**Files:**
- Create: `Argo/Services/SSH/SSHConfigParser.swift`
...
Run: `xcodebuild test -project Argo.xcodeproj -scheme Argo -only-testing ArgoTests/SSHConfigParserTests 2>&1 | tail -20`
...
```swift
// Argo/Services/SSH/SSHConfigParser.swift
import Foundation
...
```bash
git add Argo/Services/SSH/SSHConfigParser.swift Tests/SSHConfigParserTests.swift
...
**Files:**
- Create: `Argo/Services/SSH/SSHConfigService.swift`
...
Run: `xcodebuild test -project Argo.xcodeproj -scheme Argo -only-testing ArgoTests/SSHConfigServiceTests 2>&1 | tail -20`
Expected: Compilation error — `SSHConfigService` not defined

**Step 3: Write the SSH config service**

```swift
// Argo/Services/SSH/SSHConfigService.swift
import Foundation
...
```bash
git add Argo/Services/SSH/SSHConfigService.swift Tests/SSHConfigServiceTests.swift
...
**Files:**
- Create: `Argo/Services/Tmux/TmuxService.swift`
...
```swift
// Argo/Services/Tmux/TmuxService.swift
import Foundation
...
```bash
git add Argo/Services/Tmux/TmuxService.swift Tests/TmuxServiceTests.swift
...
**Files:**
- Create: `Argo/Services/SFTP/SFTPDirectoryEntry.swift`
- Create: `Argo/Services/SFTP/SFTPService.swift`
...
```swift
// Argo/Services/SFTP/SFTPDirectoryEntry.swift
import Foundation
...
```swift
// Argo/Services/SFTP/SFTPService.swift
import Foundation
...
```bash
git add Argo/Services/SFTP/SFTPDirectoryEntry.swift Argo/Services/SFTP/SFTPService.swift Tests/SFTPServiceTests.swift
...
**Files:**
- Modify: `Argo/Domain/WorkspaceModels.swift:98-104` (SessionBackendKind)
- Modify: `Argo/Domain/WorkspaceModels.swift:629-690` (SessionBackendConfiguration)
- Modify: `Argo/Services/Terminal/SessionBackendLaunch.swift:35-104` (makeLaunchConfiguration)
...
In `Argo/Domain/WorkspaceModels.swift`:
...
```bash
git add Argo/Domain/WorkspaceModels.swift Argo/Services/Terminal/SessionBackendLaunch.swift Argo/Support/L10n.swift Tests/SessionBackendTmuxTests.swift
...
**Files:**
- Modify: `Argo/Domain/WorkspaceModels.swift:76-88` (WorkspaceKind)
- Modify: `Argo/Domain/WorkspaceModels.swift:912-974` (PaneSnapshot)
- Modify: `Argo/Domain/WorkspaceModels.swift:1272-1366` (WorkspaceRecord)
- Modify: `Argo/Domain/WorkspaceRuntime.swift:12-80` (WorkspaceModel)
...
```bash
git add Argo/Domain/WorkspaceModels.swift Argo/Domain/WorkspaceRuntime.swift Argo/Support/L10n.swift Tests/RemoteWorkspaceModelTests.swift
...
**Files:**
- Modify: `Argo/Services/Terminal/ShellSession.swift:73-151` (add tmux detection)
- Create: `Argo/Services/Process/ProcessTree.swift`
...
```swift
// Add to Argo/Services/Terminal/ShellSession.swift (or create Argo/Services/Tmux/TmuxTitleDetector.swift)
...
```swift
// Argo/Services/Process/ProcessTree.swift
import Foundation
import Darwin
...
```bash
git add Argo/Services/Terminal/ShellSession.swift Argo/Services/Process/ProcessTree.swift Tests/TmuxDetectionTests.swift
...
**Files:**
- Modify: `Argo/Services/Terminal/WorkspaceSessionController.swift:44-55` (replaceSessions)
...
```bash
git add Argo/Services/Terminal/WorkspaceSessionController.swift Tests/TmuxRestoreTests.swift
...
**Files:**
- Modify: `Argo/Services/Terminal/SessionBackendLaunch.swift:169-180` (sshBootstrapCommands)
...
```bash
git add Argo/Services/Terminal/SessionBackendLaunch.swift Tests/SessionBackendTmuxTests.swift
...
**Files:**
- Modify: `Argo/Services/Git/GitRepositoryService.swift` (add remote inspection)
...
```bash
git add Argo/Services/Git/GitRepositoryService.swift Tests/RemoteGitInspectionTests.swift
...
**Files:**
- Modify: `Argo/App/WorkspaceStore.swift` (add remote refresh scheduler)
...
```bash
git add Argo/App/WorkspaceStore.swift
...
**Files:**
- Modify: `Argo/App/WorkspaceStore.swift` (add addRemoteWorkspace, createRemoteWorkspaceRequest)
- Modify: `Argo/Domain/WorkspaceModels.swift` (add CreateRemoteWorkspaceRequest)
...
```bash
git add Argo/Domain/WorkspaceModels.swift Argo/App/WorkspaceStore.swift Argo/Support/L10n.swift
...
**Files:**
- Create: `Argo/UI/Sheets/RemoteDirectoryBrowserViewModel.swift`
- Create: `Argo/UI/Sheets/RemoteDirectoryBrowser.swift`

**Step 1: Create the ViewModel**

```swift
// Argo/UI/Sheets/RemoteDirectoryBrowserViewModel.swift
import Foundation
...
```swift
// Argo/UI/Sheets/RemoteDirectoryBrowser.swift
import SwiftUI
...
```bash
git add Argo/UI/Sheets/RemoteDirectoryBrowserViewModel.swift Argo/UI/Sheets/RemoteDirectoryBrowser.swift Argo/Support/L10n.swift
...
**Files:**
- Create: `Argo/UI/Sheets/CreateRemoteWorkspaceSheet.swift`
- Modify: `Argo/UI/MainWindowView.swift:565` (add sheet presentation)

**Step 1: Create the sheet**

```swift
// Argo/UI/Sheets/CreateRemoteWorkspaceSheet.swift
import SwiftUI
...
```bash
git add Argo/UI/Sheets/CreateRemoteWorkspaceSheet.swift Argo/UI/MainWindowView.swift Argo/Support/L10n.swift
...
**Files:**
- Modify: `Argo/UI/Sidebar/WorkspaceSidebarView.swift:1815-1831` (WorkspaceRowContent badges)
- Modify: `Argo/Support/L10n.swift` (add badge entry)
...
```bash
git add Argo/UI/Sidebar/WorkspaceSidebarView.swift Argo/Support/L10n.swift
...
**Files:**
- Modify: `Argo/UI/Sidebar/WorkspaceSidebarView.swift` (add menu item)
- Modify: `Argo/Support/ApplicationMenuController.swift` (add File menu item)
...
```bash
git add Argo/UI/Sidebar/WorkspaceSidebarView.swift Argo/Support/ApplicationMenuController.swift Argo/Support/L10n.swift
...
```bash
xcodebuild test -project Argo.xcodeproj -scheme Argo 2>&1 | tail -30
```
...
9. Quit and relaunch Argo — verify tmux session auto-reattaches
