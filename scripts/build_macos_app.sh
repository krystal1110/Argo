...
EXECUTABLE_NAME="${EXECUTABLE_NAME:-Argo}"
...
VENDORED_GHOSTTY_ARCHS="$(lipo -archs "$ROOT_DIR/Argo/Vendor/GhosttyKit.xcframework/macos-arm64_x86_64/libghostty.a" 2>/dev/null || true)"
...
if [[ -n "$SIGNING_IDENTITY" ]]; then
  ENTITLEMENTS_PATH="${ENTITLEMENTS_PATH:-$ROOT_DIR/Argo/Argo.entitlements}"
